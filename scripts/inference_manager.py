...
class InferSegmentation():
    def __init__(self, weights: str,
                 architecture='Unet', encoder='resnet34', depth=5, in_channels=3, classes=2, activation='softmax',
                 resize=1024, gpu=0):
        ...
        # define a model
        self.model = SegmentationModels(architecture=self.architecture,
    ...
    def _transform_imgs(self, imgs):
        ...
        imgs_resized = F.interpolate(imgs.float(), scale_factor=(self.resize_ratio, self.resize_ratio),
        ...
        imgs_pdded = F.pad(input=imgs_resized, pad=[pad_w, pad_w, pad_h, pad_h],
                           mode='constant', value=self._PAD_VALUE)
