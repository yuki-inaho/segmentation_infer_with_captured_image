...
def main(config_name):
    ...
    torch.onnx.export(inference.model.half(), dummy_input, "model.onnx", input_names=["input"], output_names=["output"], verbose=False, opset_version=11, operator_export_type=torch.onnx.OperatorExportTypes.ONNX)
