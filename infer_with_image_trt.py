...
def main(input_data_dir, output_data_dir, onnx_name):
    ...
    for image_path in tqdm(image_path_list):
        ...
        cuda.memcpy_dtod(tensor.data_ptr(), d_output, trt.volume(engine.get_binding_shape(1)) * 4)

        output_numpy_array_flatten = cuda.from_device(d_output, 1024*1024*2, dtype=np.float32)
